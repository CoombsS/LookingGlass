...
<head>
  ...
  <style>
    ...
    input[type="text"], input[type="password"], input[type="email"] { width:100%; padding:10px 12px; border:1px solid #e6e9ef; border-radius:8px; font-size:15px; box-sizing:border-box; }
    ...
    .success { padding:8px 20px; color:#166534; background:#dcfce7; border-bottom:1px solid #bbf7d0; }
  </style>
</head>
<body>
